...
#define MACHINE_UUID "8d7f5805-8301-45b7-b3da-de3f14faa310"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // E3D v6 clone at 170°
    #define DEFAULT_Kp 24.938
    #define DEFAULT_Ki 1.123
    #define DEFAULT_Kd 138.406
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.28, 79.76, 399.10, 410.74 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 200, 8000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0216 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.5, 1.0, -0.98 }
